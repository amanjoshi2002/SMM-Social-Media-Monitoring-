...
TWITTER_SCRAPER_ACTOR_ID = os.getenv('TWITTER_SCRAPER_ACTOR_ID')
INSTAGRAM_SCRAPER_ACTOR_ID = os.getenv('INSTAGRAM_SCRAPER_ACTOR_ID')

TWITTER_API_URL = f"https://api.apify.com/v2/acts/{TWITTER_SCRAPER_ACTOR_ID}/runs?token={API_KEY}"
INSTAGRAM_API_URL = f"https://api.apify.com/v2/acts/{INSTAGRAM_SCRAPER_ACTOR_ID}/runs?token={API_KEY}"
